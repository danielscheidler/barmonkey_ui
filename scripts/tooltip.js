...
config. BgColor 		= '#888888' // Background colour (HTML colour value, in quotes)
...
config. FadeIn			= 2300 		// Fade-in duration in ms, e.g. 400; 0 for no animation
config. FadeOut			= 2000
config. FadeInterval	= 40		// Duration of each fade step in ms (recommended: 30) - shorter is smoother but causes more CPU-load
config. Fix				= [170, 160]		// Fixated position - x- an y-oordinates in brackets, e.g. [210, 480], or null for no fixation
config. FollowMouse		= false		// false or true - tooltip follows the mouse
config. FontColor		= '#77ddff'
...
config. TitleFontColor	= '#333333'	// Color of title text - if '', BgColor (of tooltip body) will be used
config. TitleFontFace	= ''		// If '' use FontFace (boldified)
config. TitleFontSize	= ''		// If '' use FontSize
config. TitlePadding	= 2
config. Width			= 700 		// Tooltip width; 0 for automatic adaption to tooltip content; < -1 (e.g. -240) for a maximum width for that automatic adaption;
