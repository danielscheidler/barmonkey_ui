...
function PMA_langDetails($lang)
{
    ...
    case 'bn':
        return array('bn|bangla', 'bn', 'à¦¬à¦¾à¦à¦²à¦¾');
    case 'be':
    ...
    case 'cs':
        return array('cs|czech', 'cs', 'ÄeÅ¡tina');
    case 'cy':
    ...
    case 'ta':
        return array('ta|tamil', 'ta', 'à®¤à®®à®¿à®´à¯');
    case 'te':
        return array('te|telugu', 'te', 'à°¤à±à°²à±à°à±');
    case 'th':
        return array('th|thai', 'th', '&#3616;&#3634;&#3625;&#3634;&#3652;&#3607;&#3618;');
    case 'tk':
        return array('tk|turkmen', 'tk', 'tÃ¼rkmenÃ§e');
    case 'tr':
        return array('tr|turkish', 'tr', 'T&uuml;rk&ccedil;e');
    case 'tt':
        return array('tt|tatarish', 'tt', 'Tatar&ccedil;a');
    case 'ug':
        return array('ug|uyghur', 'ug', 'Ø¦ÛÙØºÛØ±ÚÛ');
    case 'uk':
        return array('uk|ukrainian', 'uk', '&#1059;&#1082;&#1088;&#1072;&#1111;&#1085;&#1089;&#1100;&#1082;&#1072;');
    case 'ur':
        return array('ur|urdu', 'ur', 'Ø§ÙØ±Ø¯ÙÙ');
    case 'uz@latin':
