...
class User  extends Object {
  ...
  //MAIL MIT TEMPLATE SENDEN
     ...
     $mail->setSubject("Login-Informationen fÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼r: ".$_SERVER["HTTP_HOST"]);
...
class UserStatus extends Object{
  ...
  function activateUser( $userId, $activateLink ) {
     ...
     if ( $usrDbRow->getNamedAttribute( "activationString" ) == $activateLink ){
        ...
        $err = new Message("Aktivierungs-Code OK", "Aktivierung abgeschlossen. Sie kÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶nnen sich nun anmelden");

     } else {
        
        $err = new Error("Falscher Aktivierungs-Code", "Der Aktivierungs-Code ist ungÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼ltig!");
     }
