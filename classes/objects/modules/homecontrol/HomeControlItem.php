...
class HomeControlItem extends Object {
    ...
    function getIconTooltip( $configButtons = true ) {
        $ttt = "<table cellspacing='10'><tr><td colspan=2><center><b>" . $this->OBJNAME .
            "</b></center><hr></td></tr>" . "<tr><td>Funk-Id: </td><td align='right'>" . $this->FUNK_ID .
            "</td></tr>";
        ...
        switch ( $this->ART ) {
            case 1:
                // Steckdosen
                $ttt .= "<tr><td><a href='http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&" .
                    $this->FUNK_ID . "' target='arduinoSwitch'><div style=\"border-width:3px; border-style:solid;border-color:black;background-color:green;width:50;height:40;text-align:center;\" ><h1>AN</h1></div></a></td>" .
                    "<td align='right'><a href='http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&-" .
                    $this->FUNK_ID . "' target='arduinoSwitch'><div style=\"border-width:3px; border-style:solid;border-color:black;background-color:red;width:50;height:40;text-align:center;\" ><h1>AUS</h1></div></a></td></tr>" .
                    "</table>";
                break;
            ...
            case 2:
                // Jalousien
                $ttt .= "<tr><td><a href='http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&" .
                    $this->FUNK_ID . "' target='arduinoSwitch'><div style=\"border-width:3px; border-style:solid;border-color:black;background-color:orange;width:70;height:40;text-align:center;\" ><h1>AUF</h1></div></a></td>" .
                    "<td align='right'><a href='http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&-" .
                    $this->FUNK_ID . "' target='arduinoSwitch'><div style=\"border-width:3px; border-style:solid;border-color:black;background-color:#7777ee;width:70;height:40;text-align:center;\" ><h1>ZU</h1></div></a></td></tr>" .
                    "</table>";
                break;
            ...
            case 3:
                // Glühbirne
                $ttt .= "<tr><td><a href='http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&" .
                    $this->FUNK_ID . "' target='arduinoSwitch'><div style=\"border-width:3px; border-style:solid;border-color:black;background-color:green;width:70;height:40;text-align:center;\" ><h1>AN</h1></div></a></td>" .
                    "<td align='right'><a href='http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&-" .
                    $this->FUNK_ID . "' target='arduinoSwitch'><div style=\"border-width:3px; border-style:solid;border-color:black;background-color:red;width:70;height:40;text-align:center;\" ><h1>AUS</h1></div></a></td></tr>" .
                    "</table>";
                break;
            ...
            case 4:
                // Heizung
                $ttt .= "<tr><td><a href='http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&-" .
                    $this->FUNK_ID . "' target='arduinoSwitch'><div style=\"spacing:1px;border-width:3px; border-style:solid;border-color:black;background-color:blue;width:100;height:40;text-align:center;\" ><h1>KALT</h1></div></a></td>" .
                    "<td align='right'><a href='http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&" .
                    $this->FUNK_ID . "' target='arduinoSwitch'><div style=\"border-width:3px; border-style:solid;border-color:black;width:100;height:40;text-align:center;background-color:red;\" ><h1>WARM</h1></div></a></td></tr>" .
                    "</table>";
                break;
    ...
    function getMobileSwitch() {
        ...
        $lnkAn = new Link( "http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&" . $this->FUNK_ID,
            $divAn, false, "arduinoSwitch" );
        ...
        $lnkAus = new Link( "http://" . $_SESSION['config']->PUBLICVARS['arduino_url'] . "?schalte&-" . $this->FUNK_ID,
            $divAus, false, "arduinoSwitch" );
    ...
    function getIconPath() {
        $dbTable = new DbTable( $_SESSION['config']->DBCONNECT, 'homecontrol_art', array( "pic" ), "", "",
            "", "id=" . $this->ART );
    ...
    function isFunkId2Needed() {
        $dbTable = new DbTable( $_SESSION['config']->DBCONNECT, 'homecontrol_art', array( "zweite_funkid_jn" ),
            "", "", "", "id=" . $this->ART );
        $row = $dbTable->getRow( 1 );
    ...
    function show() {
        if ( $this->EDIT_MODE ) {
            echo "<a href=\"?editControl=" . $this->ID . "\" style=\"position:absolute; left:" . $this->X .
                "px; top:" . $this->Y . "px; width:" . $this->CONTROL_IMAGE_WIDTH . "px; height:" . $this->CONTROL_IMAGE_HEIGHT .
                "px;\">";
            ...
            echo "<div style=\"position:absolute; left:" . $this->X . "px; top:" . $this->Y . "px; width:" . $this->CONTROL_IMAGE_WIDTH .
                "px; height:" . $this->CONTROL_IMAGE_HEIGHT . "px;\">";
            echo $this->getControlArtIcon();
            echo "</div>";
        }
    }
