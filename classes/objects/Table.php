...
/*
Beispiel für Mouse-Over Style-Wechsel:

    $x->setClass("NormalListRow1");
    $x->setMouseOver("this.className='HoverListRow'");
    $x->setMouseOut("this.className='NormalListRow1'");
*/
...
class Table extends Object {
    ...
    function Table( $columnNames ) {
        ...
        $info = getimagesize( $_SERVER['DOCUMENT_ROOT'] . dirname( $_SERVER['SCRIPT_NAME'] ) .
            "/pics/table/" . $this->TABLEDESIGN . "_top_left_bg.png" );
    ...
    function show() {
        if ( $this->DESIGNJN == "J" ) {
            echo "<table cellpadding='" . $this->getPadding() . "' cellspacing='" . $this->getSpacing() . "' " .
                $this->getClassTag();
            ...
            echo ">
          <tr>
            <td background='pics/table/" . $this->TABLEDESIGN . "_top_left_bg.png' height='" . $this->DESIGNHEIGHT .
                "' width='" . $this->DESIGNWIDTH . "'>
            </td>
            <td background='pics/table/" . $this->TABLEDESIGN . "_top_center_bg.png' height='" . $this->DESIGNHEIGHT .
                "'>
            </td>
            <td background='pics/table/" . $this->TABLEDESIGN . "_top_right_bg.png' height='" . $this->DESIGNHEIGHT .
                "' width='" . $this->DESIGNHEIGHT . "'>
            </td>
          </tr>
      ...
      ";
          ...
          <tr>
            <td background='pics/table/" . $this->TABLEDESIGN . "_bottom_left_bg.png' height='" . $this->DESIGNHEIGHT .
                "' width='" . $this->DESIGNWIDTH . "'>
            </td>
    ...
    function showTable() {
        ...
        // HEADER ANZEIGEN
        //---------------------------------------------------
        if ( count( $this->COLNAMES ) >= 0 && $this->HEADER_ENABLED && isset( $this->COLNAMES[0] ) && strlen
            ( $this->COLNAMES[0] ) > 0 ) {
            echo "
				 <tr>
			  ";
