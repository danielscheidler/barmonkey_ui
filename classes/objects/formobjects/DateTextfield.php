...
class DateTextfield extends Object {
    ...
    function setDateFormat( $formatstring ) {
        $validFormats = array( "YYYYMMDD", "YYYY-MM-DD", "YYYY-DD-MM", "YYYY/MM/DD", "YYYY/DD/MM",
            "YYYY-DD-MON", "YYYY-MON-DD", "MM-DD-YYYY", "DD-MM-YYYY", "MM/DD/YYYY", "DD/MM/YYYY", "DD-MON-YYYY",
            "MON-DD-YYYY" );

        if ( array_search( $formatstring, $validFormats ) != false ) {
            $this->DATEFORMAT = $formatstring;
        } else {
            $e = new Error( "Falsches Format", "DateTextfield " . $this->NAME .
                " wurde versucht ein falsches Datumsformat zu setzen!", "mailto:d.scheidler@web.de" );
        }
