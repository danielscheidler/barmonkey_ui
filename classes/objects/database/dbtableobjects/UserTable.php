...
class UserTable extends DbTable {
    ...
    function UserTable( &$con ) { //Konstruktor
        ...
        $cNames = array( "id", "Vorname", "Nachname", "Name", "Geburtstag", "Strasse", "Plz", "Ort", "Email",
            "Telefon", "Fax", "Handy", "Icq", "Aim", "Homepage", "User", "Pw", "Nation", "Status", "Newsletter",
            "Signatur", "Lastlogin", "Lastpost", "Posts", "prepost", "Hobbys", "Beschreibung", "pic", "pnnotify",
            "autoforumnotify", "registerDate", "emailJN", "icqJN", "telefonJN", "last_notifymail",
            "last_logincheck" );
