...
class Panel extends Object {
    ...
    function setContent( $object ) {
        if ( method_exists( $object, "show" ) ) {
            ...
            $e = new Error( "Fehler in Panel.setContent()",
                "Das mitgegebene Objekt enthÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤lt keine show-Methode." );
        }
    }
